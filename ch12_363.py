# -*- coding: utf-8 -*-
"""
Created on Thu Feb  2 08:16:46 2017
...
class MLPGradientCheck(object):
    def __init__(self,n_output,n_features,n_hidden=30,l1=0.0,l2=0.0,epochs=500
                 ,eta=0.01,alpha=0.0,decrease_const=0.0,shuffle=True
    ...
    def _sigmoid(self,z):
        #exip is equivalent to 1.0/(1.0+np.exp(-z))
        return expit(z)
        
    def _sigmod_gradient(self,z):
        sg=self._sigmoid(z)
        return sg*(1-sg)
    ...
    def _get_gradient(self,a1,a2,a3,z2,y_enc,w1,w2):
        ...
        sigma2=w2.T.dot(sigma3)*self._sigmod_gradient(z2)
        sigma2=sigma2[1:,:]
        grad1=sigma2.dot(a1)
